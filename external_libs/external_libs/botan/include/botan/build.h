...
* 'configure.py '--distribution-info=vcpkg x64-mingw-static' --disable-cc-tests --with-pkg-config --link-method=copy --with-debug-info --includedir=include --bindir=bin --libdir=lib --without-documentation --with-external-includedir=F:/vcpkg/installed/x64-mingw-static/include --cpu=x86_64 --os=mingw --cc=gcc --disable-shared --enable-static  --with-external-libdir=F:/vcpkg/installed/x64-mingw-static/lib'
*
* Target
*  - Compiler: C:/msys64/ucrt64/bin/x86_64-w64-mingw32-g++.exe -fstack-protector -m64 -pthread -std=c++20 -D_REENTRANT -DNDEBUG -O3
*  - Arch: x86_64
*  - OS: mingw
*/
 ...
 */
#define BOTAN_DISTRIBUTION_INFO "vcpkg x64-mingw-static"
