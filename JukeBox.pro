...
QT += core gui network sql # تمام ماژول های مورد نیاز در یک خط جمع شد
QT += concurrent # اگر از این ماژول هم استفاده می کنید، می توانید اینجا اضافه کنید

greaterThan(QT_MAJOR_VERSION, 4): QT += widgets

CONFIG += c++17 # از c++17 استفاده می کنیم، نه c++11
...
INCLUDEPATH += $$PWD/curl # این خط رو فقط یک بار نیاز دارید
LIBS += -L$$PWD/lib -lcurl
